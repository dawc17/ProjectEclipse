...
8. Move `example.phase3` outside `Mods` and restart. Its achievements disappear and the original
   Frenzy sprite returns. Move it back into `Mods` and restart: earned progress should return.
