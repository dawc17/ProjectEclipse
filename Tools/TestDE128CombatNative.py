...
def main():
    ...
    pairs.append((ROOT / 'Mods/de128/scripts/content/sensei_rewards.lua',
                  Path('Mods/fixture.de128-combat/scripts/content/sensei_rewards.lua')))
    pairs.append((ROOT / 'Mods/de128/scripts/content/sensei_boss_opponents.lua',
