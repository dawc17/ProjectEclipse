...
foreach ($name in @('sensei_progression','sensei_map','sensei_notification_text','sensei_notifications','sensei_state','sensei_victory','sensei_victory_data','sensei_victory_text','sensei_art','sensei_dialog','sensei_defeat_text')) {
