...
const moveCondition=`${E('MovePerkCondition')}|${E('MoveNamedCondition')}|${E('MoveConditionGroup')}|${E('MoveCharacterCondition')}|${E('MoveKeysCondition')}|${E('MoveStageCondition')}|${E('MoveScreenCondition')}|${E('MoveModCondition')}|${E('MoveActorCondition')}|${E('MoveBulletsCondition')}`;
