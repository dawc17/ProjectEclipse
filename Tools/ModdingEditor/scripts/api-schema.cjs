...
const moveCondition=`${E('MovePerkCondition')}|${E('MoveNamedCondition')}|${E('MoveConditionGroup')}|${E('MoveCharacterCondition')}|${E('MoveKeysCondition')}|${E('MoveStageCondition')}|${E('MoveRoundResultCondition')}|${E('MoveScreenCondition')}|${E('MoveModCondition')}|${E('MoveActorCondition')}|${E('MoveBulletsCondition')}|${E('MoveDistanceCondition')}`;
...
type('MovePatch',{move:'string','disable?':'boolean','conditions?':move['conditions?'],'interval_start?':E('MoveIntervalStartPatch'),'interval_end?':E('MoveIntervalEndPatch'),'hit?':E('MoveHitPatch'),'sound_frame?':E('MoveSoundFramePatch'),'input?':E('MoveInputPatch'),'priority?':E('MovePriorityPatch')});reg('moves.patch','MovePatch',null,'content.patch');
