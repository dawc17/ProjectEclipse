...
type('MovePatch',{move:'string','disable?':'boolean','conditions?':move['conditions?'],'interval_end?':E('MoveIntervalEndPatch'),'hit?':E('MoveHitPatch'),'sound_frame?':E('MoveSoundFramePatch'),'input?':E('MoveInputPatch'),'priority?':E('MovePriorityPatch')});reg('moves.patch','MovePatch',null,'content.patch');
