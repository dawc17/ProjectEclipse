...
type('RewardDefinition',{id:'string','items?':E('ItemGrant')+'[]','choices?':E('RewardChoice')+'[]','gems?':'integer','experience?':['integer','0..1000000 experience points; default 0.'],'prize_base?':['number','Finite 0..1000000 native performance-bonus base; omitted keeps fallback. Not a fixed coin award.']});reg('rewards.register','RewardDefinition','Reward');
