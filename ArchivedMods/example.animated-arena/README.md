...
Enable and Apply & Restart. Find Animated Arena using the map-page dots. During
the fight the original battlefield backdrop drifts vertically and fades over a
four-second loop; controls and combat use normal rules. This is decorative motion.
