...
namespace Newtonsoft.Json
{
	public class JsonValidatingReader : JsonReader, IJsonLineInfo
	{
		...
		private ValidationEventHandler ValidationEventHandler__BackingField;
		...
		public event ValidationEventHandler ValidationEventHandler
		{
			add
			{
				ValidationEventHandler validationEventHandler = ValidationEventHandler__BackingField;
				ValidationEventHandler validationEventHandler2;
				do
				{
					validationEventHandler2 = validationEventHandler;
					validationEventHandler = Interlocked.CompareExchange(ref ValidationEventHandler__BackingField, (ValidationEventHandler)Delegate.Combine(validationEventHandler2, value), validationEventHandler);
				}
			...
			remove
			{
				...
				{
					validationEventHandler2 = validationEventHandler;
					validationEventHandler = Interlocked.CompareExchange(ref ValidationEventHandler__BackingField, (ValidationEventHandler)Delegate.Remove(validationEventHandler2, value), validationEventHandler);
				}
				while ((object)validationEventHandler != validationEventHandler2);
			}
		}
		...
		{
			ValidationEventHandler validationEventHandler__BackingField = ValidationEventHandler__BackingField;
			if (validationEventHandler__BackingField != null)
			{
				validationEventHandler__BackingField(this, new ValidationEventArgs(exception));
				return;
			}
			throw exception;
		}
