...
namespace Newtonsoft.Json.Utilities
{
	internal static class ConvertUtils
	{
		...
		{
			return MiscellaneousUtils.TryAction(() =>
			{
				object convertedValue2;
				TryConvert(initialValue, CultureInfo.CurrentCulture, typeof(T), out convertedValue2);
		...
		public static bool TryConvertOrCast<T>(object initialValue, CultureInfo culture, out T convertedValue)
		{
			...
			{
				object convertedValue2;
				TryConvertOrCast(initialValue, CultureInfo.CurrentCulture, typeof(T), out convertedValue2);
				return (T)convertedValue2;
			}, out convertedValue);
		}
