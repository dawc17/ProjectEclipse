...
{
	public abstract class JToken : IEnumerable<JToken>, IJEnumerable<JToken>, IEnumerable, ICloneable, IJsonLineInfo
	{
		...
		public static explicit operator decimal?(JToken value)
		{
			...
			return (jValue.Value == null) ? ((decimal?)null) : new decimal?(Convert.ToDecimal(jValue.Value, CultureInfo.InvariantCulture));
		}
		...
		public static explicit operator int?(JToken value)
		{
			...
			return (jValue.Value == null) ? ((int?)null) : new int?(Convert.ToInt32(jValue.Value, CultureInfo.InvariantCulture));
		}
		...
		public static explicit operator short?(JToken value)
		{
			...
			return (jValue.Value == null) ? ((short?)null) : new short?(Convert.ToInt16(jValue.Value, CultureInfo.InvariantCulture));
		}
		...
		public static explicit operator ushort?(JToken value)
		{
			...
			return (jValue.Value == null) ? ((ushort?)null) : new ushort?((ushort)Convert.ToInt16(jValue.Value, CultureInfo.InvariantCulture));
		}
		...
		public static explicit operator float?(JToken value)
		{
			...
			return (jValue.Value == null) ? ((float?)null) : new float?(Convert.ToSingle(jValue.Value, CultureInfo.InvariantCulture));
		}
