...
{
	public abstract class JContainer : JToken, IList<JToken>, ICollection<JToken>, IEnumerable<JToken>, IList, IEnumerable, ICollection
	{
		...
		public override JToken First
		{
			get
			{
				return ChildrenTokens.FirstOrDefault();
			}
		}
		...
		public override JToken Last
		{
			get
			{
				return ChildrenTokens.LastOrDefault();
			}
		}
