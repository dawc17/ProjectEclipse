...
namespace Newtonsoft.Json
{
	public class JsonSerializer
	{
		...
		private EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> Error__BackingField;
		...
		public virtual event EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> Error
		{
			add
			{
				EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> eventHandler = Error__BackingField;
				EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> eventHandler2;
				do
				{
					eventHandler2 = eventHandler;
					eventHandler = Interlocked.CompareExchange(ref Error__BackingField, (EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs>)Delegate.Combine(eventHandler2, value), eventHandler);
				}
			...
			remove
			{
				...
				{
					eventHandler2 = eventHandler;
					eventHandler = Interlocked.CompareExchange(ref Error__BackingField, (EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs>)Delegate.Remove(eventHandler2, value), eventHandler);
				}
				while ((object)eventHandler != eventHandler2);
			}
		}
		...
		{
			EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> error__BackingField = Error__BackingField;
			if (error__BackingField != null)
			{
				error__BackingField(this, e);
			}
		}
	}
}
