...
namespace Newtonsoft.Json
{
	public class JsonTextReader : JsonReader, IJsonLineInfo
	{
		...
		public override decimal? ReadAsDecimal()
		{
			...
			decimal result;
			if (TokenType == JsonToken.String && decimal.TryParse((string)Value, NumberStyles.Number, Culture, out result))
			{
		...
		public override DateTimeOffset? ReadAsDateTimeOffset()
		{
			...
			if (TokenType == JsonToken.String && DateTimeOffset.TryParse((string)Value, Culture, DateTimeStyles.None, out result))
			{
