...
public class SelectAnimation
{
	...
	private void UpdateConditions(ModelConditions conditions, Model ACENLMONNPA)
	{
		...
		conditions.NCBPMBJCFBK = ACENLMONNPA.COBOFMDFLJO().IsPhysics();
		conditions.EKFCILFBDPO = fGCODGKLHED != null && fGCODGKLHED.COBOFMDFLJO().IsPhysics();
		conditions.LFLDHGKEDEH = fGCODGKLHED2 != null && fGCODGKLHED2.COBOFMDFLJO().IsPhysics();
		conditions.KAKMANLHJOA = ACENLMONNPA.COBOFMDFLJO().GetFrame();
